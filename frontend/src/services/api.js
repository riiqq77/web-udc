...
export const anggotaService = {
  ...
  create: (data) => api.post('/anggota', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  update: (id, data) => api.post(`/anggota/${id}`, { ...data, _method: 'PUT' }, { headers: { 'Content-Type': 'multipart/form-data' } }),
...
export const portfolioService = {
  ...
  create: (data) => api.post('/portfolio', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
...
export const pendaftaranService = {
  submit: (data) => api.post('/pendaftaran', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  getAll: (params) => api.get('/pendaftaran', { params }),
  getById: (id) => api.get(`/pendaftaran/${id}`),
  updateStatus: (id, status) => api.patch(`/pendaftaran/${id}/status`, { status }),
