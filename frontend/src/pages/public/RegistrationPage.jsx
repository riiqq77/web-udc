...
export default function RegistrationPage() {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        setOpenRegistration(res.data.open_registration);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.nama || !form.email || !form.divisi_id)
  ...
  if (!openRegistration)
    return (
      <div className="pt-20 min-h-screen flex items-center justify-center bg-white dark:bg-neutral-950 px-4">
        <div className="max-w-xl text-center">
          <h1 className="text-4xl font-bold text-neutral-900 dark:text-white mb-4">
            Pendaftaran Ditutup
          </h1>
          <p className="text-neutral-500 mb-6">
            Admin telah menonaktifkan rekrutmen anggota saat ini. Coba lagi
            nanti atau hubungi tim UDC untuk informasi lebih lanjut.
          </p>
    ...
    return (
      <div className="pt-20 min-h-screen flex items-center justify-center bg-white dark:bg-neutral-950">
        ...
        >
          ...
          <p className="text-neutral-500 mb-6">
            Terima kasih telah mendaftar. Tim kami akan menghubungi kamu melalui
            email.
          </p>
          <Button
            variant="outline"
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-lg text-neutral-500">
              Isi formulir di bawah untuk bergabung dengan UDC
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Input
                label="Email *"
                type="email"
                placeholder="email@student.untirta.ac.id"
                value={form.email}
            ...
            <Select
              ...
              onChange={(e) => update("divisi_id", e.target.value)}
              required
            />
            <Textarea
              label="Alasan Bergabung *"
              placeholder="Ceritakan motivasi kamu bergabung dengan UDC..."
              rows={4}
              value={form.motivasi}
