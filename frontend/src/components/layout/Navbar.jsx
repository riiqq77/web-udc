...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? "bg-white/80 dark:bg-neutral-950/80 backdrop-blur-xl shadow-soft border-b border-neutral-200/50 dark:border-neutral-800/50" : "bg-transparent"}`}
    >
              ...
              >
                ...
                {location.pathname === link.path && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-3 right-3 h-0.5 bg-royal-purple-600 rounded-full"
                  />
                )}
              </Link>
            ))}
